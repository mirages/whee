...
export declare type SimpleData = string | number | {
    text: string | number;
};
export declare type Cascadable<T extends Exclude<SimpleData, string | number>> = {
    [P in keyof T]: T[P];
} & {
...
export declare type IdxCascadable<T extends Exclude<SimpleData, string | number>> = Indexable<Cascadable<T>>;
