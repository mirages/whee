...
export declare function distanceToAngle(distance: number, radius: number): number;
export declare function getEle(el: string | HTMLElement, ancestorEle?: HTMLElement | Document): HTMLElement | null;
